...
# Runtime: 123 ms, faster than 8.96% of Python3 online submissions for Bag of Tokens.
...
class Solution:
    def bagOfTokensScore(self, tokens: List[int], power: int) -> int:
        ...
        res1 = res2 = 0
        while deque and (power >= deque[0] or res2):
...
run_functional_tests(Solution().bagOfTokensScore, tests)
