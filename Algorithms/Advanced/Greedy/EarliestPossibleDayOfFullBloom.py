...
# Beats
# 77.74%
# https://leetcode.com/problems/earliest-possible-day-of-full-bloom/solutions/2582720/earliest-possible-day-of-full-bloom/
class Solution:
...
run_functional_tests(Solution().earliestFullBloom, tests)