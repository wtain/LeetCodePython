...
# Runtime: 1251 ms, faster than 85.38% of Python3 online submissions for Minimum Operations to Reduce X to Zero.
# Memory Usage: 27.9 MB, less than 82.08% of Python3 online submissions for Minimum Operations to Reduce X to Zero.
# https://leetcode.com/problems/minimum-operations-to-reduce-x-to-zero/discuss/2045072/Simple-C%2B%2B-code-ororO(N)-time-oror-O(1)-space
class Solution:
    def minOperations(self, nums: List[int], x: int) -> int:
        n = len(nums)
        l, r, t = -1, n-1, x
