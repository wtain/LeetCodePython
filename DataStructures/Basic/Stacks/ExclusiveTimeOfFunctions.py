...
# Runtime: 78 ms, faster than 80.83% of Python3 online submissions for Exclusive Time of Functions.
# Memory Usage: 14 MB, less than 71.92% of Python3 online submissions for Exclusive Time of Functions.
# class Solution:
...
# Runtime: 89 ms, faster than 63.96% of Python3 online submissions for Exclusive Time of Functions.
# Memory Usage: 14 MB, less than 71.92% of Python3 online submissions for Exclusive Time of Functions.
class Solution:
    def exclusiveTime(self, n: int, logs: List[str]) -> List[int]:
        times = [0] * n
...
run_functional_tests(Solution().exclusiveTime, tests)
