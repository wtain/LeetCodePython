...
# Memory Usage: 14.3 MB, less than 42.86% of Python3 online submissions for Check Whether Two Strings are Almost Equivalent.
class Solution:
...
run_functional_tests(Solution().checkAlmostEquivalent, tests)
