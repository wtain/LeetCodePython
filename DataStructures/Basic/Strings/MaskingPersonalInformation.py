...
class Solution:
    def maskPII(self, s: str) -> str:
        ...
        def mask_phone(phone: str) -> str:
            ...
            last_local_digits = local_number[-4:]
            result = "***-***-" + last_local_digits
            if len(country_code) > 0:
                result = "+" + "*" * len(country_code) + "-" + result
            return result

        return mask_email(s) if is_email(s) else mask_phone(s)
...
run_functional_tests(Solution().maskPII, tests)
