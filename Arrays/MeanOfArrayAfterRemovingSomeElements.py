...
# Runtime: 60 ms, faster than 50.41% of Python3 online submissions for Mean of Array After Removing Some Elements.
...
for test in tests:
    result = Solution().trimMean(test[0])
    if abs(result - test[1]) < 10**(-5):
        print("PASS")
    else:
